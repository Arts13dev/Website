...
try {
    ...
    $totalProducts = $totalUsers = $totalOrders = $totalRevenue = 0;
    $recentOrders = $lowStockProducts = $monthlySales = [];
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="bg-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="products.php" class="text-gray-700 hover:text-purple-600 px-3 py-2 rounded-md font-medium">
                        Products
                    </a>
    ...
    <main class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            ...
            <p class="text-gray-600">Welcome back, <?php echo htmlspecialchars($_SESSION['fullName']); ?>!</p>
        </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900"><?php echo number_format($totalProducts); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900"><?php echo number_format($totalOrders); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">R<?php echo number_format($totalRevenue, 2); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="products.php" class="text-purple-600 hover:text-purple-800 text-sm">View All</a>
                </div>
                    ...
                    <div class="space-y-3">
                        <?php foreach ($lowStockProducts as $product): ?>
                            <div class="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                                <div class="flex items-center">
                                    <img src="<?php echo $product['image'] ? htmlspecialchars($product['image']) : 'https://placehold.co/40x40'; ?>"
                                ...
                                <span class="px-2 py-1 bg-red-100 text-red-800 text-xs rounded-full">Low Stock</span>
                            </div>
                        <?php endforeach; ?>
                    </div>
                <?php endif; ?>
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    ...
                    <a href="orders.php" class="text-purple-600 hover:text-purple-800 text-sm">View All</a>
                </div>
            </div>
